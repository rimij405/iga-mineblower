...
The xFade() method crossfades between the currently playing track and a new one.

In addition to reading the actual tunes from the mp3 files listed below, the file BackgndGains.txt contains gain levels for the 6 tunes, one per line in the same order as the files.
